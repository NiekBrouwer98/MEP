...
finished_files <- list.files(here('scratch/init_parameters/'))
...
all_combos_dists <- readRDS(here('scratch/all_combos_dists.rds'))

# Directory for intermediate results
if (!dir.exists(here('scratch/init_parameters'))){
...
initial_parameters <-mclapply(combinations_selection, mc.cores = 14, function(c){
  message(c)
