...
outfile <- paste(here('scratch/init_parameters_'),name,sep='')
...
if (!dir.exists(paste(here('scratch/init_parameters_'),name, sep = ''))){
  dir.create(paste(here('scratch/init_parameters_'),name, sep = ''))
}else{
  message("dir exists")
}

finished_files <- list.files(paste(here('scratch/init_parameters_'),name,'/', sep = ''))
...
saveRDS(all_combos_dists, file = paste(here('scratch/all_combos_dists_'),name,'.rds', sep = ''))
print('first step complete')



# Use dataset generated by code above
all_combos_dists <- readRDS(paste(here('scratch/all_combos_dists_'),name,'.rds', sep = ''))
