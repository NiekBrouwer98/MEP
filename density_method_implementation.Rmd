...
# cells <- cells %>% mutate(is_epithelial = ifelse(meta_description == "Ki67+_cells", FALSE, is_epithelial))
```
...
saveRDS(cellPhenotypes, file=here('scratch/features/regions/cell_proportions_per_imageVS.rds'))
