...
saveRDS(cell_occurences_matrix, file= here('scratch/features/cell_counts_per_image.rds'))
...
saveRDS(cellPhenotypes, file=here('scratch/features/cell_proportions_per_image.rds'))
